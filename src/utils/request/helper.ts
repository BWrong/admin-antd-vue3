...
export const handleRefreshToken: {
  ...
  void refreshTokenRequest({ refresh_token: refreshToken })
...
export const messageAdaptor = {
  destroy: (...args: Parameters<typeof message.destroy>) => message.destroy(...args),
  error: (...args: Parameters<typeof message.error>) => message.error(...args),
  success: (...args: Parameters<typeof message.success>) => message.success(...args),
  warn: (...args: Parameters<typeof message.warning>) => message.warning(...args),
};
/**
